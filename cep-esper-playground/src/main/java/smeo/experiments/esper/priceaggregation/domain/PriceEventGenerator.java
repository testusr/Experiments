...
public class PriceEventGenerator {
    ...
    private static class Stream {
        ...
        public boolean equals(Object o) {
            ...
            if (Double.compare(stream.baseValue, baseValue) != 0) return false;
            if (Double.compare(stream.maxSpread, maxSpread) != 0) return false;
            if (bankName != null ? !bankName.equals(stream.bankName) : stream.bankName != null) return false;
